let globalMultiplier = 2;
    ...
    // Function to animate a box by adding/removing a class
    function animateBox(boxId, times) {
      ...
      const interval = setInterval(() => {
        ...
        count++;
        if (count >= times * 2) { // toggle flips twice per interval
          clearInterval(interval);
        }
      }, 500);
    }

    // Function to calculate sum of two numbers and multiply by global variable
    function calculateSum(a, b) {
      return (a + b) * globalMultiplier;
    }

    // Function to animate multiple boxes
